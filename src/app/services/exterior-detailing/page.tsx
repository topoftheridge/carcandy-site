...
export const metadata: Metadata = {
  ...
  description: "Professional exterior auto detailing in Delaware County, PA. Hand wash, paint decontamination, tire & wheel cleaning, trim restoration. Starting at $90.",
};
    ...
    <section className="relative py-16 lg:py-24 bg-dark">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-300 text-lg leading-relaxed mb-10">
          A complete exterior treatment that goes far beyond a car wash. We decontaminate, restore, and protect every exterior surface so your vehicle shines from every angle.
        </p>
